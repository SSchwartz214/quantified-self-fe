...
const appendCaloriesSnacks = () => {
  ...
  $('td#snack-item-calories').each(function (index, item) {
    snackCalories += parseInt(item.innerHTML)
  })
...
const displayCalorieTotals = () => {
  ...
  $('#total-snack-calories').html(snackCalories)
  $('#remaining-snack-calories').html(goalSnackCalories - snackCalories)
}
